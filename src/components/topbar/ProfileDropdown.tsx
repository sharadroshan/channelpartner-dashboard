        ...
        <Dropdown.Menu className="dropdown-menu-end profile-dropdown">
          <div onClick={toggleDropdown}>
            <div className="dropdown-header noti-title">
              ...
              <Link className="dropdown-item notify-item" to="/channel/inbox">
                <i className="ri-inbox-archive-line me-1"></i>
                <span>My Inbox</span>
              </Link>
              <Link className="dropdown-item notify-item" to="/channel/wallet">
