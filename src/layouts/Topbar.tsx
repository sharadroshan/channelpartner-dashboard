                ...
                <Card.Body className="py-2">
                    <Marquee gradient={false} speed={50} style={{marginTop: '80px'}}>
                        <div className='d-flex align-items-center'>
                            <h5 className='mx-2 mb-0 mt-0 text-warning'>Total Teachers : 140 </h5> ||
                            <h5 className='mx-2 mb-0 mt-0 text-info'>Total Students : 230</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-info'>Total Schools : 230</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-danger'>Total Classes : 440</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-primary'>Total Career Experts : 30</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-danger'>Total Channel Partners : 440</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-primary'>Total Garages : 30</h5>||
                        </div>
                    </Marquee>
                </Card.Body>
            </Card>
