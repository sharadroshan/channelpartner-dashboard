        ...
        <Table>
          ...
          <tbody>
            <tr>
              ...
              <td>0</td>
              <td>15 days	</td>
              <td><span className="bg-success px-2 py-1 text-white rounded-pill">Approved </span></td>
            </tr>
            <tr>
              <td>
                  <Form.Group >
            ...
            <tr>
              ...
              <td>15 days	</td>
              <td>
                <span className="bg-warning px-2 py-1 text-white rounded-pill">Rejected</span>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>0</td>
              <td>15 days	</td>
              <td><span className="bg-warning px-2 py-1 text-white rounded-pill">Rejected</span></td>
            </tr>
            <tr>
              <td>
                  <Form.Group >
              ...
              <td>0</td>
              <td>15 days	</td>
              <td><span className="bg-danger px-2 py-1 text-white rounded-pill">Cancelled </span></td>
            </tr>
            <tr>
              <td>
                  <Form.Group >
